"""
Script para rellenar la base de datos 'presupuesto_db' en PostgreSQL usando Faker.
...
def insertar_usuarios(n=5):
    for _ in range(n):
        ...
        """, (
            fake.name(),
            fake.job()[:50],   # <-- recortamos a 50 caracteres
            fake.email()[:100],
...
print("Base de datos 'presupuesto_db' en PostgreSQL rellenada con datos falsos correctamente.")

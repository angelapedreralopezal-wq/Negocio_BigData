"""
Script para rellenar la base de datos 'presupuesto_db' en MariaDB usando Faker.
Se utilizan 10 providers distintos de Faker:

1. name           → nombres de personas
2. company        → nombres de proveedores y empresas
3. address        → direcciones
4. phone_number   → teléfonos
5. email          → correos electrónicos
6. date_between   → fechas de emisión, pagos, mantenimiento, etc.
7. job            → roles de usuarios
8. text           → descripciones
9. random_int     → cantidades, IDs aleatorios
10. random_element → seleccionar valores de listas (método de pago, estado, prioridad)
"""
